...
class NavigateForwardButton(QPushButton):
    def __init__(self, browsing_context: BrowsingContext, parent=None):
        ...
        browsing_context.web_view_page_history_can_go_forward.connect(self.on_web_view_page_history_can_go_forward)
    ...
    def on_web_view_page_history_can_go_forward(self, can_go_forward: bool) -> None:
